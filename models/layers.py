...
inputs3d =  keras.layers.Input(shape=[80,80,80,3], name='cnn3d_inputs')
inputs4d = keras.layers.Input(shape=[80,80,80,5], name='cnn3d_inputs4d')
inputs5d = keras.layers.Input(shape=[80,80,80,5], name='cnn3d_inputs4d')
